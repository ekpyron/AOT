...
lemma AOT_meta_A_objects_\<kappa>:
  ...
  by (metis (no_types, lifting) AOT_rel_equiv_def Quotient_rep_abs_fold_unmap
                                urrel_quotient)
...
next
  ...
  hence \<open>AOT_model_valid_in w (Rep_urrel r (\<kappa>\<upsilon> \<kappa>)) =
    ...
    by (metis AOT_rel_equiv_def Abs_rel_inverse Quotient3_rel_rep iso_tuple_UNIV_I
  ...
  hence \<open>AOT_model_valid_in v (Rep_urrel (rel_to_urrel \<Pi>') (\<omega>\<upsilon> x)) =
    ...
    by (smt (verit, best) AOT_rel_equiv_def Abs_rel_inverse Quotient3_def \<Pi>'_den
          \<kappa>\<upsilon>.simps(1) iso_tuple_UNIV_I r_prop urrel_quotient3 urrel_to_rel_def)
...
next
  ...
  hence 0: \<open>AOT_urrel_\<omega>equiv (rel_to_urrel \<Pi>') (rel_to_urrel \<Pi>)\<close>
    unfolding AOT_urrel_\<omega>equiv_def
    by (smt (verit) AOT_rel_equiv_def Abs_rel_inverse Quotient3_def \<Pi>'_den \<Pi>_den
                    \<kappa>\<upsilon>.simps(1) iso_tuple_UNIV_I urrel_quotient3 urrel_to_rel_def)
