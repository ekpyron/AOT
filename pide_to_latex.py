...
referencedEntities = {
	...
	"AOT_model.AOT_model_concrete<omega>",
	"AOT_model.AOT_model_nonactual_world",
	"AOT_model.<omega>",
	"AOT_model.<sigma>",
	"AOT_model.null",
	"AOT_model.<upsilon>",
	...
	"AOT_semantics.AOT_RelationProjection",
	"AOT_semantics.AOT_UnaryRelationProjection",
	...
	"AOT_semantics.AOT_instance_of_cqt_2_intros_exe_lam",
	"AOT_PLM.AOT_Term_id",
	"AOT_PLM.unvarify",
