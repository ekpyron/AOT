...
\newcommand{\pidesymmathbbP}{$\mathbb{P}$}
\newcommand{\pidesymmathcalP}{$\mathcal{P}$}
...
We can support this claim by verifying Uri Nodelman's and Edward Zalta's reconstruction of Frege's theorem: we can confirm that the Peano-Dedekind postulates for natural numbers are consistently derivable in AOT using Frege's method. Furthermore, we can suggest and discuss generalizations and variants of the construction and can thereby provide theoretical insights into, and contribute to the philosophical justification of, the construction.
