...
proof
  AOT_modally_strict {
    AOT_show \<open>\<exists>x O!x\<close>
      by (meson "B\<diamond>" T_S5_fund_1 o_objects_exist_1 "vdash-properties:10")
  }
next
  AOT_modally_strict {
    AOT_show \<open>O!\<kappa> \<rightarrow> \<kappa>\<down>\<close> for \<kappa>
      by (simp add: "deduction-theorem" russell_axiom_exe_1.\<psi>_denotes_asm)
  }
next
  AOT_modally_strict {
  ...
  AOT_modally_strict {
    ...
    then AOT_obtain x where x_prop: \<open>O!x & \<phi>{x} & \<forall>\<beta> (O!\<beta> & \<phi>{\<beta>} \<rightarrow> \<beta> = x)\<close> using "\<exists>E"[rotated] by blast
    {
      ...
      AOT_hence \<open>\<beta> =\<^sub>E x\<close>
        using ord_eq_E_eq[THEN "\<rightarrow>E", OF "\<or>I"(1)[OF beta_ord], THEN "qml:2"[axiom_inst, THEN "\<rightarrow>E"], THEN "\<equiv>E"(1)]
        by blast
    }
  ...
  AOT_modally_strict {
    ...
    proof(rule GEN; rule "\<rightarrow>I")
      ...
      AOT_thus \<open>y = x\<close>
        using ord_eq_E_eq[THEN "\<rightarrow>E", OF "\<or>I"(2)[OF x_prop[THEN "&E"(1)]], THEN "qml:2"[axiom_inst, THEN "\<rightarrow>E"], THEN "\<equiv>E"(2)] by blast
    qed
...
proof (safe intro!: "&I" GEN "\<rightarrow>I" "cqt:2[const_var]"[axiom_inst] "\<equiv>\<^sub>d\<^sub>fI"[OF equi_3] "\<equiv>\<^sub>d\<^sub>fI"[OF equi_2] "\<exists>I"(1))
  ...
  proof(rule equi_1[THEN "\<equiv>\<^sub>d\<^sub>fI"]; rule "\<exists>I"(2)[where \<beta>=x]; safe dest!: "&E"(2) intro!:  "&I" "\<rightarrow>I" 1 2 Ordinary.GEN ord_eq_Eequiv_1[THEN "\<rightarrow>E", OF 1])
  ...
  proof (AOT_subst \<open>\<lambda> \<kappa> \<kappa>' . \<guillemotleft>[\<lambda>xy [R]yx]\<kappa>\<kappa>'\<guillemotright>\<close> \<open>\<lambda> \<kappa> \<kappa>' . \<guillemotleft>[R]\<kappa>'\<kappa>\<guillemotright>\<close>;
    ...
    AOT_modally_strict {
      AOT_have \<open>[\<lambda>xy [R]yx]xy\<close> if \<open>[R]yx\<close> for y x
        by(rule betaC_2_a; "cqt:2[lambda]" ; simp add: "&I" ex_1_a prod_denotesI rule_ui_3 that)
      ...
      ultimately AOT_show \<open>[\<lambda>xy [R]yx]\<alpha>\<beta> \<equiv> [R]\<beta>\<alpha>\<close> for \<alpha> \<beta>
        by (metis "deduction-theorem" intro_elim_2)
    }
  qed
  ...
  proof (rule "\<equiv>\<^sub>d\<^sub>fI"[OF equi_1])
    ...
    next
      ...
      AOT_show \<open>[R]uc\<close>
        ...
        apply (rule betaC_2_a; "cqt:2[lambda]")
        by (auto simp: "&I" ex_1_a prod_denotesI rule_ui_3 0)
    next
      fix x
...
proof -
  ...
  next
    ...
    proof (safe intro!: "\<rightarrow>I")
      ...
      AOT_have 0: \<open>[\<lambda>x [O!]x & [F]x]u\<close>
        by (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: "cqt:2[const_var]"[axiom_inst] Ordinary.\<psi> fu "&I")
    ...
    proof (safe intro!: "\<rightarrow>I")
      ...
      AOT_have 0: \<open>[\<lambda>x [O!]x & [G]x]v\<close>
        by (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: "cqt:2[const_var]"[axiom_inst] Ordinary.\<psi> gu "&I")
  ...
  proof(safe intro!: "\<equiv>I" "\<rightarrow>I" "&I")
    ...
    next
      ...
      AOT_thus \<open>t =\<^sub>E u\<close> using "rule=E" id_sym ord_eq_Eequiv_1 Ordinary.\<psi> ta ua "vdash-properties:10" by fast
    next
      fix u
      AOT_assume fu: \<open>[F]u\<close>
      ...
      proof(safe intro!: Ordinary.GEN "\<rightarrow>I"; frule "&E"(1); drule "&E"(2))
        ...
        AOT_thus \<open>v =\<^sub>E a\<close> using "rule=E" ord_eq_Eequiv_1 Ordinary.\<psi> "vdash-properties:10" by fast
      qed
    ...
    next
      ...
      proof(safe intro!: GEN "\<rightarrow>I"; frule "&E"(1); drule "&E"(2))
        ...
        ultimately AOT_have \<open>z =\<^sub>E y\<close>
          ...
          by blast
        AOT_thus \<open>z = y\<close> using 2[THEN "&E"(1)] by (metis eq_E_simple_2 "vdash-properties:10")
      qed
    ...
    next
      ...
      next
        ...
        AOT_thus \<open>z = x\<close>
          by (metis eq_E_simple_2 "vdash-properties:10")
      qed
...
proof(rule "\<rightarrow>I")
  ...
  proof (safe intro!: "\<exists>I"(1)[where \<tau>="\<guillemotleft>(=\<^sub>E)\<guillemotright>"] equi_2[THEN "\<equiv>\<^sub>d\<^sub>fI"] "&I" eq_E_denotes "cqt:2[const_var]"[axiom_inst] Ordinary.GEN "\<rightarrow>I" equi_1[THEN "\<equiv>\<^sub>d\<^sub>fI"])
    fix u
    AOT_assume Fu: \<open>[F]u\<close>
...
next
  ...
  AOT_hence rigid: \<open>[H]x \<equiv> \<^bold>\<A>[H]x\<close> for x
     by (metis intro_elim_3_f oth_class_taut_3_a sc_eq_fur_2 "vdash-properties:10")
...
proof(rule "\<rightarrow>I"; frule "&E"(1); drule "&E"(2))
  ...
  proof(rule Ordinary.GEN; rule "\<rightarrow>I"; rule raa_cor_1)
    fix u
...
proof (rule "\<rightarrow>I"; frule "&E"(2); drule "&E"(1); frule "&E"(2); drule "&E"(1))
    ...
    by (rule \<Pi>_minus_\<kappa>I) "cqt:2[lambda]"+
  {
    ...
    proof(safe intro!: equi_2[THEN "\<equiv>\<^sub>d\<^sub>fI"] "&I" "cqt:2[const_var]"[axiom_inst] \<Pi>_minus_\<kappa>_den Ordinary.GEN "\<rightarrow>I")
      ...
      AOT_have 0: \<open>[F]u' & u' \<noteq>\<^sub>E u\<close>
        by (rule betaC_1_a[where \<kappa>\<^sub>1\<kappa>\<^sub>n="AOT_term_of_var (Ordinary.Rep u')"]) (fact 0)
      ...
      proof (safe intro!: equi_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] "Ordinary.\<exists>I"[where \<beta>=v'] "&I" Ordinary.GEN "\<rightarrow>I")
        ...
        proof (rule \<Pi>_minus_\<kappa>I; rule betaC_2_a; "cqt:2[lambda]";
               safe intro!: "cqt:2[const_var]"[axiom_inst] "&I" thm_neg_eq_E[THEN "\<equiv>E"(2)])
        ...
        next
          ...
          proof (rule raa_cor_2)
            ...
            AOT_hence \<open>v' = v\<close> by (metis eq_E_simple_2 "vdash-properties:10")
            ...
            moreover AOT_have \<open>\<not>(u' =\<^sub>E u)\<close>
              using "0" "&E"(2) intro_elim_3_a thm_neg_eq_E by blast
      ...
      next
        ...
        AOT_have gt_t_noteq_v: \<open>[G]t & t \<noteq>\<^sub>E v\<close>
          apply (rule betaC_1_a[where \<kappa>\<^sub>1\<kappa>\<^sub>n="AOT_term_of_var (Ordinary.Rep t)"])
    ...
    next
      ...
      AOT_have gt_t_noteq_v: \<open>[G]v' & v' \<noteq>\<^sub>E v\<close>
        apply (rule betaC_1_a[where \<kappa>\<^sub>1\<kappa>\<^sub>n="AOT_term_of_var (Ordinary.Rep v')"])
        apply (rule \<Pi>_minus_\<kappa>E)
        by (fact G_minus_v_v')
      ...
      proof (safe intro!: equi_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] "Ordinary.\<exists>I"[where \<beta>=u'] "&I" Ordinary.GEN "\<rightarrow>I" u'_prop[THEN "&E"(1), THEN "&E"(2)])
        ...
        proof (rule \<Pi>_minus_\<kappa>I; rule betaC_2_a; "cqt:2[lambda]";
               safe intro!: "cqt:2[const_var]"[axiom_inst] "&I" thm_neg_eq_E[THEN "\<equiv>E"(2)]
               u'_prop[THEN "&E"(1), THEN "&E"(1)]; rule raa_cor_2)
          AOT_assume u'_eq_u: \<open>u' =\<^sub>E u\<close>
          AOT_hence \<open>u' = u\<close>
            using eq_E_simple_2 "vdash-properties:10" by blast
          ...
          AOT_hence \<open>v' =\<^sub>E v\<close> using "rule=E" eq_E_simple_2 id_sym "vdash-properties:10" by fast
  ...
  moreover {
    ...
    proof(rule raa_cor_2)
      ...
      AOT_hence 0: \<open>v = b\<close> by (metis eq_E_simple_2 "vdash-properties:10")
    ...
    AOT_have not_b_eq_v: \<open>\<not>(b =\<^sub>E v)\<close>
      using "modus-tollens:1" not_v_eq_b ord_eq_Eequiv_2 by blast
    ...
    proof(rule raa_cor_2)
      ...
      AOT_hence 0: \<open>u = a\<close> by (metis eq_E_simple_2 "vdash-properties:10")
    ...
    AOT_have not_a_eq_u: \<open>\<not>(a =\<^sub>E u)\<close>
      using "modus-tollens:1" not_u_eq_a ord_eq_Eequiv_2 by blast
    ...
    proof -
      ...
      AOT_hence \<open>x \<noteq>\<^sub>E u & y \<noteq>\<^sub>E v & [R]xy\<close> using that(2,3)
        by (metis con_dis_i_e_4_c "Conjunction Simplification"(1) intro_elim_3_a "modus-tollens:1" thm_neg_eq_E)
    ...
    proof -
      ...
      AOT_have \<open>(x \<noteq>\<^sub>E u & y \<noteq>\<^sub>E v & [R]xy) \<or> (x =\<^sub>E a & y =\<^sub>E b) \<or> (x =\<^sub>E u & y =\<^sub>E v)\<close>
        using betaC_1_a[OF 0] by simp
      AOT_hence \<open>x \<noteq>\<^sub>E u & y \<noteq>\<^sub>E v & [R]xy\<close> using that(2,3)
        by (metis con_dis_i_e_4_c "Conjunction Simplification"(2) intro_elim_3_a "modus-tollens:1" thm_neg_eq_E)
      AOT_thus \<open>[R]xy\<close> using "&E" by blast+
    qed
    AOT_have R\<^sub>1xy: \<open>[R\<^sub>1]xy\<close> if \<open>[R]xy\<close> and \<open>x \<noteq>\<^sub>E u\<close> and \<open>y \<noteq>\<^sub>E v\<close> for x y
      ...
      apply (rule betaC_2_a; "cqt:2[lambda]"; simp add: "&I" ex_1_a prod_denotesI rule_ui_3)
      using that "&I" con_dis_i_e_3_a by presburger
    AOT_have R\<^sub>1ab: \<open>[R\<^sub>1]ab\<close>
      apply (rule "rule=E"[rotated, OF R\<^sub>1_def[symmetric]])
      apply (rule betaC_2_a; "cqt:2[lambda]"; simp add: "&I" ex_1_a prod_denotesI rule_ui_3)
      by (meson a_prop b_prop "&I" "&E"(1) con_dis_i_e_3_a con_dis_i_e_3_b ord_eq_Eequiv_1 "vdash-properties:10")
    AOT_have R\<^sub>1uv: \<open>[R\<^sub>1]uv\<close>
      apply (rule "rule=E"[rotated, OF R\<^sub>1_def[symmetric]])
      apply (rule betaC_2_a; "cqt:2[lambda]"; simp add: "&I" ex_1_a prod_denotesI rule_ui_3)
      by (meson "&I" con_dis_i_e_3_b ord_eq_Eequiv_1 Ordinary.\<psi> "vdash-properties:10")
    ...
    proof (safe intro!: equi_2[THEN "\<equiv>\<^sub>d\<^sub>fI"] "&I" "cqt:2[const_var]"[axiom_inst] Ordinary.GEN "\<rightarrow>I")
      ...
      AOT_assume fu': \<open>[F]u'\<close>
      {
        ...
        proof (rule raa_cor_2)
          AOT_assume \<open>v' =\<^sub>E v\<close>
          AOT_hence \<open>v' = v\<close> by (metis eq_E_simple_2 "vdash-properties:6")
        ...
        proof (safe intro!: "&I" gv' R\<^sub>1xy Ru'v' u'_noteq_u u'_noteq_a Ordinary.GEN "\<rightarrow>I" thm_neg_eq_E[THEN "\<equiv>E"(2)] not_v'_eq_v)
          fix t
      ...
      moreover {
        ...
        AOT_hence u'_eq_u: \<open>u' = u\<close>
          using eq_E_simple_2 "vdash-properties:6" by blast
        ...
        proof (safe intro!: equi_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] "Ordinary.\<exists>I"[where \<beta>=v] "&I" Ordinary.GEN "\<rightarrow>I" gv)
          AOT_show \<open>[R\<^sub>1]u'v\<close>
            apply (rule "rule=E"[rotated, OF R\<^sub>1_def[symmetric]])
            apply (rule betaC_2_a; "cqt:2[lambda]"; simp add: "&I" ex_1_a prod_denotesI rule_ui_3)
            by (safe intro!: "\<or>I"(2) "&I" 0 ord_eq_Eequiv_1[THEN "\<rightarrow>E", OF Ordinary.\<psi>])
        next
          fix v'
          ...
          AOT_have \<open>\<not>u \<noteq>\<^sub>E u\<close>
            using intro_elim_3_d "modus-tollens:1" ord_eq_Eequiv_1 Ordinary.\<psi> "reductio-aa:2" thm_neg_eq_E by blast
          AOT_hence \<open>\<not>((u \<noteq>\<^sub>E u & v' \<noteq>\<^sub>E v & [R]uv') \<or> (u =\<^sub>E a & v' =\<^sub>E b))\<close>
            using not_u_eq_a by (metis con_dis_i_e_4_b "Conjunction Simplification"(1) "modus-tollens:1" "reductio-aa:1")
        ...
        proof (safe intro!: equi_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] "\<exists>I"(2)[where \<beta>=b] "&I" Ordinary.GEN "\<rightarrow>I" b_prop[THEN "&E"(1)]
          ...
          AOT_show \<open>[R\<^sub>1]u'b\<close>
            ...
            apply (rule "\<or>I"(1); rule "\<or>I"(2); rule "&I")
             apply (fact 0)
            using b_prop "&E"(1) ord_eq_Eequiv_1 "vdash-properties:10" by blast
        next
          fix v'
          ...
          moreover {
            ...
            ultimately AOT_have \<open>v' =\<^sub>E v\<close>
              by (metis "&I" ord_eq_Eequiv_2 ord_eq_Eequiv_3 "vdash-properties:10")
          ...
          ultimately AOT_show \<open>v' =\<^sub>E b\<close> by (metis "&E"(2) con_dis_i_e_4_c "reductio-aa:1") 
        qed
      }
    ...
    next
      ...
      AOT_assume gv': \<open>[G]v'\<close>
      {
        ...
        proof (rule raa_cor_2)
          ...
          AOT_hence \<open>u' = u\<close> by (metis eq_E_simple_2 "vdash-properties:6")
        ...
        proof (safe intro!: "&I" gv' R\<^sub>1xy Ru'v' u'_noteq_u Ordinary.GEN "\<rightarrow>I" thm_neg_eq_E[THEN "\<equiv>E"(2)] not_v'_eq_v fu')
          fix t
      ...
      moreover {
        ...
        next
          ...
          AOT_hence \<open>\<not>((u' \<noteq>\<^sub>E u & v \<noteq>\<^sub>E v & [R]u'v) \<or> (u' =\<^sub>E a & v =\<^sub>E b))\<close>
            by (metis "&E"(1) "&E"(2) con_dis_i_e_4_c not_v_eq_b raa_cor_3)
          AOT_hence \<open>(u' =\<^sub>E u & v =\<^sub>E v)\<close> using 2 by (metis con_dis_i_e_4_b)
      ...
      moreover {
        ...
        proof (safe intro!: equi_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] "\<exists>I"(2)[where \<beta>=a] "&I" Ordinary.GEN "\<rightarrow>I" b_prop[THEN "&E"(1)]
          ...
          AOT_show \<open>[R\<^sub>1]av'\<close>
            ...
            apply (rule betaC_2_a; "cqt:2[lambda]"; simp add: "&I" ex_1_a prod_denotesI rule_ui_3)
            apply (rule "\<or>I"(1); rule "\<or>I"(2); rule "&I")
            using oa ord_eq_Eequiv_1 "vdash-properties:10" apply blast
            using "0" by blast
        next
          fix u'
          ...
          ultimately AOT_show \<open>u' =\<^sub>E a\<close> by (metis "&E"(1) con_dis_i_e_4_c "reductio-aa:1") 
        qed
      }
...
proof(safe intro!: "\<rightarrow>I"; frule "&E"(1); drule "&E"(2); frule "&E"(1); drule "&E"(2))
  ...
  proof -
    ...
    AOT_have \<open>[\<lambda>z [\<Pi>]z & z \<noteq>\<^sub>E \<kappa>]\<kappa>'\<close> by (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: \<kappa>'_den "&I" that)
  ...
  proof(safe intro!: equi_3[THEN "\<equiv>\<^sub>d\<^sub>fI"] "\<exists>I"(1)[where \<tau>="?R"] R_den equi_2[THEN "\<equiv>\<^sub>d\<^sub>fI"] "&I" "cqt:2[const_var]"[axiom_inst] Ordinary.GEN "\<rightarrow>I")
    ...
    AOT_assume Fr: \<open>[F]r\<close>
    {
      ...
      AOT_have \<open>[[F]\<^sup>-\<^sup>u]r\<close>
        by(rule \<Pi>_minus_\<kappa>I; rule betaC_2_a; "cqt:2[lambda]"; safe intro!: "cqt:2[const_var]"[axiom_inst] "&I" Fr r_noteq_u)
      ...
      proof(safe intro!: "Ordinary.\<exists>I"[where \<beta>=s] "&I" Gs Ordinary.GEN "\<rightarrow>I")
        AOT_show \<open>[\<guillemotleft>?R\<guillemotright>]rs\<close>
          by (rule betaC_2_a; "cqt:2[lambda]"; simp add: "&I" ex_1_a prod_denotesI rule_ui_3;
      ...
      next
        ...
        AOT_hence 1: \<open>[[F]\<^sup>-\<^sup>u]r & [[G]\<^sup>-\<^sup>v]t & [R]rt\<close>
          using not_r_eq_u by (metis "&E"(1) con_dis_i_e_4_c "reductio-aa:1")
    ...
    moreover {
      ...
      proof(safe intro!: "Ordinary.\<exists>I"[where \<beta>=v] "&I" Gv Ordinary.GEN "\<rightarrow>I")
        AOT_show \<open>[\<guillemotleft>?R\<guillemotright>]rv\<close>
          by (rule betaC_2_a; "cqt:2[lambda]"; simp add: "&I" ex_1_a prod_denotesI rule_ui_3)
             (safe intro!: "&I" "\<or>I"(2) \<Pi>_minus_\<kappa>I' Fr r_eq_u ord_eq_Eequiv_1[THEN "\<rightarrow>E", OF Ordinary.\<psi>])
      next
        fix t
        AOT_assume 0: \<open>[G]t & [\<guillemotleft>?R\<guillemotright>]rt\<close>
        AOT_hence \<open>([[F]\<^sup>-\<^sup>u]r & [[G]\<^sup>-\<^sup>v]t & [R]rt) \<or> (r =\<^sub>E u & t =\<^sub>E v)\<close>
        ...
        AOT_hence \<open>r =\<^sub>E u & t =\<^sub>E v\<close>
          using r_eq_u \<Pi>_minus_\<kappa>E2 by (metis "&E"(1) con_dis_i_e_4_b intro_elim_3_a "reductio-aa:1" thm_neg_eq_E)
  ...
  next
...

    {
      ...
      AOT_have \<open>[[G]\<^sup>-\<^sup>v]s\<close>
        by (rule \<Pi>_minus_\<kappa>I; rule betaC_2_a; "cqt:2[lambda]"; safe intro!: "cqt:2[const_var]"[axiom_inst] "&I" Gs s_noteq_v)
      ...
      next
        ...
        AOT_hence 1: \<open>[[F]\<^sup>-\<^sup>u]t & [[G]\<^sup>-\<^sup>v]s & [R]ts\<close>
          using not_s_eq_v by (metis "&E"(2) con_dis_i_e_4_c "reductio-aa:1")
    ...
    moreover {
      ...
      proof(safe intro!: "Ordinary.\<exists>I"[where \<beta>=u] "&I" Fu Ordinary.GEN "\<rightarrow>I")
        AOT_show \<open>[\<guillemotleft>?R\<guillemotright>]us\<close>
          by (rule betaC_2_a; "cqt:2[lambda]"; simp add: "&I" ex_1_a prod_denotesI rule_ui_3)
             (safe intro!: "&I" "\<or>I"(2) \<Pi>_minus_\<kappa>I' Gs s_eq_v ord_eq_Eequiv_1[THEN "\<rightarrow>E", OF Ordinary.\<psi>])
      next
        fix t
        AOT_assume 0: \<open>[F]t & [\<guillemotleft>?R\<guillemotright>]ts\<close>
        ...
        proof (rule raa_cor_2)
          ...
          AOT_thus \<open>s =\<^sub>E v & \<not>(s =\<^sub>E v)\<close>
            by (metis \<Pi>_minus_\<kappa>E2 intro_elim_3_d "reductio-aa:1" s_eq_v thm_neg_eq_E)
        qed
...
next
  ...
  also AOT_have \<open>\<dots> \<equiv> [F]u\<close>
    using act_conj_act_4 "logic-actual"[act_axiom_inst, THEN "\<rightarrow>E"] by blast
...
proof -
  ...
  AOT_have \<theta>: \<open>\<diamond>\<exists>x [\<guillemotleft>?P\<guillemotright>]x & \<diamond>\<not>\<exists>x [\<guillemotleft>?P\<guillemotright>]x\<close>
    apply (AOT_subst \<open>\<lambda>\<kappa> . \<guillemotleft>[\<guillemotleft>?P\<guillemotright>]\<kappa>\<guillemotright>\<close> \<open>\<lambda>\<kappa> . \<guillemotleft>E!\<kappa> & \<not>\<^bold>\<A>E!\<kappa>\<guillemotright>\<close>)
     apply (rule beta_C_meta[THEN "\<rightarrow>E"]; "cqt:2[lambda]")
    by (fact 1)
  show ?thesis
        ...
        next
          ...
          proof (rule raa_cor_2)
            ...
            moreover AOT_have \<open>\<not>[L\<^sup>-]u\<close>
              ...
              by (metis "qml:2" rule_ui_3 "vdash-properties:10" "vdash-properties:1[2]")
      ...
      AOT_modally_strict {
        ...
        next
          ...
          AOT_hence \<open>E!x & \<not>\<^bold>\<A>E!x\<close>
            by (rule betaC_1_a)
          AOT_hence 1: \<open>\<diamond>E!x\<close> by (metis T_S5_fund_1 "&E"(1) "vdash-properties:10")
          AOT_have \<open>[\<lambda>x \<diamond>E!x]x\<close>
            by (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: "cqt:2[const_var]"[axiom_inst] 1)
        ...
        next
          ...
          proof (rule raa_cor_2)
            ...
            moreover AOT_have \<open>\<box>\<not>[L\<^sup>-]u\<close>
              using thm_noncont_e_e_2[THEN contingent_properties_2[THEN "\<equiv>\<^sub>d\<^sub>fE"], THEN "&E"(2)]
              by (metis RN "qml:2" rule_ui_3 "vdash-properties:10" "vdash-properties:1[2]")
            ultimately AOT_show \<open>p & \<not>p\<close> for p by (metis Act_Sub_3 KBasic2_1 intro_elim_3_a raa_cor_3 "vdash-properties:10")
          qed
        next
          AOT_show \<open>\<not>\<exists>v [\<guillemotleft>?P\<guillemotright>]v\<close>
          proof (rule raa_cor_2)
...
proof(rule "\<rightarrow>I")
  ...
  proof (safe intro!: apE_eqE_1[unvarify G, THEN "\<rightarrow>E"] eqE[THEN "\<equiv>\<^sub>d\<^sub>fI"] "&I" "cqt:2[const_var]"[axiom_inst] act_F_den Ordinary.GEN "\<rightarrow>I" "\<equiv>I")
    ...
    AOT_hence act_F_u: \<open>\<^bold>\<A>[F]u\<close> by (metis nec_imp_act "vdash-properties:10")
    AOT_show \<open>[\<lambda>z \<^bold>\<A>[F]z]u\<close>
      by (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: act_F_u "cqt:2[const_var]"[axiom_inst])
  next
    fix u
    ...
    AOT_thus \<open>[F]u\<close>
      ...
      by (metis intro_elim_3_a sc_eq_fur_2 "vdash-properties:10")
  qed
qed
...
proof (rule "\<rightarrow>I")
  ...
  AOT_hence \<open>\<box>(\<box>\<forall>x([F]x \<rightarrow> \<box>[F]x) & \<box>\<forall>x([G]x \<rightarrow> \<box>[G]x))\<close>
    using "&E"(1) "&E"(2) KBasic_3 S5Basic_5 "&I" intro_elim_3_b "vdash-properties:10" by meson
  ...
  proof(rule RM; rule "\<rightarrow>I"; rule "\<rightarrow>I")
    AOT_modally_strict {
      ...
      proof (safe intro!: Ordinary.GEN "\<rightarrow>I")
        ...
        proof (rule raa_cor_1)
          ...
          AOT_hence A: \<open>\<diamond>[F]u & \<diamond>\<not>\<exists>!v ([G]v & [R']uv)\<close>
            using KBasic2_3 "vdash-properties:10" by blast
          AOT_hence \<open>\<box>[F]u\<close>
            using F_nec "&E"(1) intro_elim_3_a sc_eq_box_box_1 "vdash-properties:6" by blast
          ...
          next
            AOT_show \<open>\<box>[R']ua\<close>
              ...
              by (metis T_S5_fund_1 "vdash-properties:10")
          next
            AOT_have \<open>\<forall>v' \<box>([G]v' & [R']uv' \<rightarrow> v' =\<^sub>E a)\<close>
            proof (rule Ordinary.GEN; rule raa_cor_1)
              fix v'
              ...
              AOT_have Gv': \<open>[G]v'\<close> using G_nec 1
                by (meson "B\<diamond>" KBasic_13 "vdash-properties:10")
              AOT_have \<open>\<box>[R']uv'\<close> using 2 D[THEN "\<forall>E"(2), THEN "\<forall>E"(2), THEN "\<rightarrow>E"] by blast
              AOT_hence R'uv': \<open>[R']uv'\<close> by (metis "B\<diamond>" T_S5_fund_1 "vdash-properties:10") 
      ...
      next
        ...
        proof (rule raa_cor_1)
          ...
          AOT_hence \<open>\<box>[G]v\<close>
            using G_nec "&E"(1) intro_elim_3_a sc_eq_box_box_1 "vdash-properties:6" by blast
          ...
          next
            ...
            proof (rule Ordinary.GEN; rule raa_cor_1)
              ...
              AOT_hence R'u'v: \<open>[R']u'v\<close> by (metis "B\<diamond>" T_S5_fund_1 "vdash-properties:10") 
      ...
      ultimately AOT_have 1: \<open>\<box>([R']\<down> & [F]\<down> & [G]\<down> & \<forall>u ([F]u \<rightarrow> \<exists>!v ([G]v & [R']uv)) & \<forall>v ([G]v \<rightarrow> \<exists>!u ([F]u & [R']uv)))\<close>
        using KBasic_3 "&I" intro_elim_3_b by meson
...
proof -
  ...
  ultimately AOT_show \<open>\<^bold>\<A>F \<approx>\<^sub>E [\<lambda>z \<^bold>\<A>[F]z]\<close>
    by (metis act_cond "vdash-properties:10")
qed
...
proof(rule RN; safe intro!: GEN "\<rightarrow>I")
  AOT_modally_strict {
    ...
    AOT_show \<open>[\<lambda>z \<box>\<^bold>\<A>[F]z]x\<close>
      by (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: 1 "cqt:2[const_var]"[axiom_inst])
  }
qed
...
proof (rule "\<rightarrow>I")
  ...
  AOT_hence c_noteqE_d: \<open>c \<noteq>\<^sub>E d\<close>
    using eq_E_simple_2[THEN "\<rightarrow>E"] eq_E_simple_2 intro_elim_3_b "modus-tollens:1" "=-infix" rule_eq_df_2 thm_neg_eq_E by fast
  ...
  proof (rule equi_3[THEN "\<equiv>\<^sub>d\<^sub>fI"])
    ...
    next
      ...
      AOT_hence u_is_c: \<open>u = c\<close>  by (metis eq_E_simple_2 "vdash-properties:6")
      ...
      proof (safe intro!: equi_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] "\<exists>I"(2)[where \<beta>=d] "&I" Od Ordinary.GEN "\<rightarrow>I")
        AOT_show \<open>[\<lambda>x x =\<^sub>E d]d\<close>
          by (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: ord_eq_Eequiv_1[THEN "\<rightarrow>E", OF Od] "cqt:2[const_var]"[axiom_inst])
      next
      ...
      next
        ...
        AOT_thus \<open>v =\<^sub>E d\<close> by (metis betaC_1_a "&E"(1))
      qed
    next
      fix v
      AOT_assume \<open>[\<lambda>x x =\<^sub>E d]v\<close>
      AOT_hence \<open>v =\<^sub>E d\<close> by (metis betaC_1_a)
      AOT_hence v_is_d: \<open>v = d\<close>  by (metis eq_E_simple_2 "vdash-properties:6")
      ...
      proof (safe intro!: equi_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] "\<exists>I"(2)[where \<beta>=c] "&I" Oc Ordinary.GEN "\<rightarrow>I")
        AOT_show \<open>[\<lambda>x x =\<^sub>E c]c\<close>
          by (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: ord_eq_Eequiv_1[THEN "\<rightarrow>E", OF Oc] "cqt:2[const_var]"[axiom_inst])
      next
      ...
      next
        ...
        AOT_thus \<open>u =\<^sub>E c\<close> by (metis betaC_1_a "&E"(1))
      qed
    next
      AOT_show \<open>\<guillemotleft>?R\<guillemotright>\<down>\<close> by "cqt:2[lambda]"
    qed
  ...
  proof (rule raa_cor_2)
    ...
    AOT_have \<open>\<box>(\<not>[\<lambda>z \<^bold>\<A>[F]z] \<approx>\<^sub>E G \<rightarrow> \<not>a[F])\<close>
      apply (AOT_subst \<open>\<guillemotleft>\<not>[\<lambda>z \<^bold>\<A>[F]z] \<approx>\<^sub>E G \<rightarrow> \<not>a[F]\<guillemotright>\<close> \<open>\<guillemotleft>a[F] \<rightarrow> [\<lambda>z \<^bold>\<A>[F]z] \<approx>\<^sub>E G\<guillemotright>\<close>)
       using intro_elim_2 "useful-tautologies:4" "useful-tautologies:5" apply presburger
       by (fact A)
    AOT_hence \<open>\<diamond>\<not>a[F]\<close> by (metis KBasic_13 \<zeta> "vdash-properties:10")
    ...
    moreover AOT_have \<open>\<diamond>a[F]\<close> by (meson B \<theta> KBasic_13 "vdash-properties:10")
...
proof(rule "\<rightarrow>I")
  ...
  proof(rule RM; safe intro!: "\<rightarrow>I" GEN)
    AOT_modally_strict {
      ...
      moreover AOT_have \<open>\<box>[A!]x\<close> using Ax using oa_facts_2 "vdash-properties:10" by blast
      ...
      AOT_hence 2: \<open>\<box>(A!x & G\<down> & \<forall>F (x[F] \<equiv> [\<lambda>z \<^bold>\<A>[F]z] \<approx>\<^sub>E G))\<close> using 1
        using KBasic_3 "&I" intro_elim_3_b by fast
...
proof (rule id_trans[OF num_can_1]; rule equiv_desc_eq_2[THEN "\<rightarrow>E"];
  ...
  also AOT_have \<open>\<dots> \<equiv> \<^bold>\<A>(\<forall>F (x[F] \<equiv> F \<approx>\<^sub>E G))\<close>
    using intro_elim_3_f "logic-actual-nec:3" oth_class_taut_3_a "vdash-properties:1[2]" by blast
  ...
  also AOT_have \<open>\<dots> \<equiv> \<^bold>\<A>[A!]x & \<^bold>\<A>(\<forall>F (x[F] \<equiv> F \<approx>\<^sub>E G))\<close>
    using 0 oth_class_taut_4_f "vdash-properties:6" by blast
...
AOT_theorem num_den: \<open>#G\<down>\<close>
  using "t=t-proper_1" num_can_1 "vdash-properties:10" by blast
...
AOT_act_theorem numbers_num: \<open>Numbers(#G, G)\<close>
  ...
  using num_uniq "vdash-properties:10" y_in_3 by blast
...
proof(rule "\<rightarrow>I")
  ...
  AOT_hence \<open>\<box>x = #G\<close> by (metis id_nec_2 "vdash-properties:10")
...
AOT_act_theorem hume_3: \<open>F \<equiv>\<^sub>E G \<rightarrow> #F = #G\<close>
  by (metis apE_eqE_1 "deduction-theorem" hume_1 intro_elim_3_b "vdash-properties:10")
...
proof(rule raa_cor_2)
  ...
  moreover AOT_have \<open>y =\<^sub>E y\<close> by (metis calculation[THEN "&E"(1)] ord_eq_Eequiv_1 "vdash-properties:10")
  ultimately AOT_show \<open>p & \<not>p\<close> for p by (metis "&E"(2) raa_cor_3)
qed
...
proof(rule raa_cor_2)
  ...
  AOT_hence \<open>\<not>(y =\<^sub>E y)\<close> using "&E"(2) intro_elim_3_a thm_neg_eq_E by blast
  moreover AOT_have \<open>y =\<^sub>E y\<close> by (metis 0[THEN "&E"(1)] ord_eq_Eequiv_1 "vdash-properties:10")
  ultimately AOT_show \<open>p & \<not>p\<close> for p by (metis raa_cor_3)
qed
...
AOT_theorem zero_card: \<open>NaturalCardinal(0)\<close>
  ...
  apply (rule "\<exists>I"(1)[where \<tau>=\<open>\<guillemotleft>[\<lambda>x [O!]x & x \<noteq>\<^sub>E x]\<guillemotright>\<close>])
   apply (rule "rule=I_1"; rule num_den'; "cqt:2[lambda]")
  by "cqt:2[lambda]"
...
proof -
  ...
  AOT_hence num_a_act_g: \<open>Numbers(a, [\<lambda>z \<^bold>\<A>[G]z])\<close>
    ...
    by (metis intro_elim_3_a sc_eq_fur_2 "vdash-properties:6")
...
proof(rule "\<rightarrow>I"; rule GEN)
  ...
  also AOT_have \<open>\<dots> \<equiv> Numbers(x, [\<lambda>z \<^bold>\<A>[F]z])\<close>
    ...
    by (metis "&I" "deduction-theorem" intro_elim_2 intro_elim_3_b num_x_act_P)
  ...
  proof (rule num_tran_3[unvarify x G H, THEN "\<rightarrow>E", THEN "\<equiv>E"(1), rotated 4])
    ...
    proof (safe intro!: eqE[THEN "\<equiv>\<^sub>d\<^sub>fI"] "&I" Ordinary.GEN "\<rightarrow>I")
      ...
      also AOT_have \<open>\<dots> \<equiv> (O!u & \<^bold>\<A>u \<noteq>\<^sub>E u)\<close>
        by (metis Ordinary.\<psi> "&I" "&E"(2) "deduction-theorem" intro_elim_2 intro_elim_3_a oa_facts_7)
      also AOT_have \<open>\<dots> \<equiv> [\<lambda>x [O!]x & \<^bold>\<A>x \<noteq>\<^sub>E x]u\<close>
        by (rule beta_C_meta[THEN "\<rightarrow>E", symmetric]; "cqt:2[lambda]")
...
proof -
  ...
  also AOT_have \<open>\<dots> \<equiv> #F = 0\<close>
    by (simp add: "deduction-theorem" id_sym intro_elim_2)
  finally show ?thesis.
qed
...
AOT_theorem ances: \<open>[R\<^sup>*]xy \<equiv> \<forall>F((\<forall>z([R]xz \<rightarrow> [F]z) & Hereditary(F,R)) \<rightarrow> [F]y)\<close>
  ...
  by (simp add: "&I" ex_1_a prod_denotesI rule_ui_3)
...
proof (rule "\<rightarrow>I")
  ...
  next
    ...
    AOT_show \<open>[\<lambda>y\<exists>x [R]xy]z\<close>
      by (rule betaC_2_a; "cqt:2[lambda]"; auto simp: "cqt:2[const_var]"[axiom_inst] 1)
  next
    fix x y
    ...
    AOT_show \<open>[\<lambda>y \<exists>x [R]xy]y\<close>
      by (rule betaC_2_a; auto simp: 0 1 "cqt:2[const_var]"[axiom_inst])
  qed
...
proof(rule "\<rightarrow>I")
  ...
  AOT_have 1: \<open>[R]xz & [R]yz \<rightarrow> \<box>x = y\<close> for x y z
    by (AOT_subst_rev \<open>\<guillemotleft>x = y\<guillemotright>\<close> \<open>\<guillemotleft>\<box>x = y\<guillemotright>\<close>)
       (auto simp: 1 id_nec_2 intro_elim_2 "qml:2" "vdash-properties:1[2]")
  ...
  AOT_hence \<open>\<box>(([R]xz \<rightarrow> \<box>[R]xz) & ([R]yz \<rightarrow> \<box>[R]yz))\<close> for x y z by (metis KBasic_3 "&I" intro_elim_3_c raa_cor_3)
  moreover AOT_have \<open>\<box>(([R]xz \<rightarrow> \<box>[R]xz) & ([R]yz \<rightarrow> \<box>[R]yz)) \<rightarrow> \<box>(([R]xz & [R]yz) \<rightarrow> \<box>([R]xz & [R]yz))\<close> for x y z
    by (rule RM) (metis "\<rightarrow>I" KBasic_3 "&I" "&E"(1) "&E"(2) intro_elim_3_b "vdash-properties:10")
    ...
    proof (rule "\<exists>I"(1)[where \<tau>=\<open>\<guillemotleft>(=\<^sub>E)\<guillemotright>\<close>])
      ...
      proof (safe intro!: df_1_1_2[THEN "\<equiv>\<^sub>d\<^sub>fI"] "&I" df_1_1_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] GEN "\<rightarrow>I" df_rigid_rel_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] eq_E_denotes)
        ...
        AOT_thus \<open>x = y\<close>
          by (metis "rule=E" "&E"(1) "Conjunction Simplification"(2) eq_E_simple_2 id_sym "vdash-properties:10")
      next
        ...
        proof(rule GEN; rule GEN)
          AOT_show \<open>\<box>(x =\<^sub>E y \<rightarrow> \<box>x =\<^sub>E y)\<close> for x y
            by (meson RN "deduction-theorem" id_nec3_1 intro_elim_3_a)
        qed
  ...
  AOT_modally_strict {
    ...
    proof(rule RN; rule "\<rightarrow>I")
      AOT_modally_strict {
        ...
        AOT_hence 2: \<open>\<box>\<Pi>\<down>\<close> using exist_nec "vdash-properties:10" by blast
...
proof(rule "\<rightarrow>I"; frule "&E"(1); drule "&E"(2))
  ...
  ultimately AOT_show \<open>[\<R>]\<^sup>*xz\<close> by (metis con_dis_i_e_4_b "reductio-aa:1")
qed
...
proof(rule "\<rightarrow>I"; frule "&E"(1); drule "&E"(2))
  ...
  moreover {
    ...
    ultimately AOT_have \<open>[\<R>]\<^sup>+xz\<close> by (metis con_dis_i_e_4_c "reductio-aa:1")
  }
...
proof(rule "\<rightarrow>I")
  ...
  proof (rule 1[THEN "\<rightarrow>E"]; "cqt:2[lambda]"?; safe intro!: "&I" GEN "\<rightarrow>I" hered_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] "cqt:2[const_var]"[axiom_inst])
    ...
    AOT_show \<open>[\<lambda>y \<exists>z ([\<R>]\<^sup>+xz & [\<R>]zy)]z\<close>
      by (rule betaC_2_a; "cqt:2[lambda]"; simp add: "cqt:2[const_var]"[axiom_inst] 1)
  next
    fix x' y
...
proof(safe intro!: "\<rightarrow>I")
  ...
  proof(rule wances_her_2[unvarify F, OF 0, THEN "\<rightarrow>E"];
    ...
    AOT_show  \<open>[\<lambda>z \<not>[\<R>]\<^sup>*zz]x\<close>
      by (rule betaC_2_a; "cqt:2[lambda]"; simp add: 1 "cqt:2[const_var]"[axiom_inst])
  next
...
proof(rule "\<rightarrow>I"; rule df_1_1_4[THEN "\<equiv>\<^sub>d\<^sub>fI"])
  ...
  next
    ...
    AOT_show \<open>[\<lambda>z [\<R>\<^sup>*]xz \<rightarrow> \<exists>y [\<R>]xy]z\<close>
      ...
      by (meson "0" "deduction-theorem" existential_2_a)
  next
    fix x' y
    AOT_assume Rx'y: \<open>[\<R>]x'y\<close>
    ...
    proof(rule "\<rightarrow>I")
      ...
      ultimately AOT_show \<open>\<exists>y [\<R>]xy\<close> by (metis con_dis_i_e_4_c "reductio-aa:1")
    qed
...
proof (rule "\<rightarrow>I")
  ...
  ultimately AOT_show \<open>InDomainOf(x,\<R>)\<close> by (metis con_dis_i_e_4_c "reductio-aa:1")
qed
...
proof(safe intro!: "\<rightarrow>I" GEN)
  ...
  proof (rule wances_her_2[unvarify F, OF den, THEN "\<rightarrow>E"]; safe intro!: "&I")
    ...
    proof (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: "cqt:2[const_var]"[axiom_inst] "&I")
  ...
  next
    ...
    proof (safe intro!: hered_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] "&I" "cqt:2[const_var]"[axiom_inst] GEN "\<rightarrow>I")
      ...
      proof (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: "cqt:2[const_var]"[axiom_inst] "&I" 3)
    ...
    qed("cqt:2[lambda]")
  qed
  AOT_thus \<open>[F]x\<close> using betaC_1_a "&E"(1) by fast
qed
...
proof - 
  ...
  AOT_modally_strict {
    fix v and x y
    AOT_assume indist: \<open>\<forall>F ([F]x \<equiv> [F]y)\<close>
    AOT_hence \<open>\<box>\<forall>F([F]x \<equiv> [F]y)\<close> using ind_nec "vdash-properties:10" by blast
    ...
    proof(safe intro!: "\<rightarrow>I")
...

      {
        ...
        AOT_hence \<open>x[G]\<close> by (metis intro_elim_3_b x_enc_cond)
        {
          ...
          AOT_hence \<open>\<^bold>\<A>\<forall>u ([H]u \<equiv> [G]u)\<close> by (metis nec_imp_act "vdash-properties:6")
          AOT_hence 0: \<open>\<forall>u \<^bold>\<A>([H]u \<equiv> [G]u)\<close>  by (metis Ordinary.res_var_bound_reas_5 "vdash-properties:10")
          {
            ...
            AOT_hence \<open>[\<lambda>z \<^bold>\<A>[H]z]u \<equiv> [\<lambda>z \<^bold>\<A>[G]z]u\<close>
              using act_beta by (metis "deduction-theorem" intro_elim_2 intro_elim_3_a intro_elim_3_b)
          } note 1 = this
        ...
        AOT_have \<open>[\<lambda>x \<forall>H(\<forall>u \<box>([H]u \<equiv> [G]u) \<rightarrow> x[H])]x\<close>
          by (rule betaC_2_a; simp add: denotes_all; simp add: "cqt:2[const_var]"[axiom_inst] 0)
      ...
      moreover {
        ...
        AOT_have \<open>[\<lambda>y \<exists>H (\<forall>u \<box>([H]u \<equiv> [G]u) & y[H])]y\<close>
          by (rule betaC_2_a; simp add: denotes_ex; simp add: "cqt:2[const_var]"[axiom_inst] 0)
        ...
        AOT_hence \<open>\<^bold>\<A>\<forall>u ([H]u \<equiv> [G]u)\<close>
          by (metis nec_imp_act "vdash-properties:6")
        ...
        AOT_hence 0: \<open>[\<lambda>x \<^bold>\<A>[H]x]u \<equiv> [\<lambda>x \<^bold>\<A>[G]x]u\<close> if \<open>O!u\<close> for u
          by (metis act_beta "deduction-theorem" intro_elim_2 intro_elim_3_a intro_elim_3_b that)
  ...
  AOT_modally_strict {
    ...
    proof (rule "\<rightarrow>I")
      ...
      AOT_have \<open>[\<lambda>x Numbers(x,F)]x\<^sub>2\<close>
        by (rule betaC_2_a; simp add: numbers_prop_den; simp add: "cqt:2[const_var]"[axiom_inst] numbers_x2_F)
      ...
      AOT_have \<open>[\<lambda>x Numbers(x,[F]\<^sup>-\<^sup>u)]x\<^sub>1\<close>
        by (rule betaC_2_a; simp add: numbers_prop_den[unvarify F, OF F_minus_u_den]; simp add: "cqt:2[const_var]"[axiom_inst] numbers_x1_F_minus_u)
...
AOT_theorem assume_anc_den: \<open>\<P>\<^sup>*\<down>\<close>
  using "t=t-proper_1" assume_anc_1 "vdash-properties:10" by blast
...
AOT_theorem no_pred_0_3: \<open>\<not>[\<P>\<^sup>*]0 0\<close>
  by (metis existential_1 no_pred_0_2 "reductio-aa:1" zero_den)
  ...
  moreover {
    ...
    next
      ...
      AOT_hence 2: \<open>[F]x & x \<noteq>\<^sub>E u\<close>
        using \<zeta> "&I" "&E"(1) "&E"(2) intro_elim_3_a rule_ui_3 by blast
      AOT_have 3: \<open>[\<lambda>x [F]x & x \<noteq>\<^sub>E u]x\<close>
        by (rule betaC_2_a; "cqt:2[lambda]"; simp add: "cqt:2[const_var]"[axiom_inst] 2)
    ...
    next
      ...
      AOT_hence 2: \<open>[G]x & x \<noteq>\<^sub>E u\<close>
        using \<zeta> "&I" "&E"(1) "&E"(2) intro_elim_3_b rule_ui_3 by blast
...
proof (safe intro!: nnumber_2[unvarify x, OF zero_den, THEN "\<equiv>E"(2)]
  ...
  proof (safe intro!: pred_thm_2[unvarify x, OF zero_den, THEN "\<equiv>E"(2)]
    ...
    AOT_show \<open>[\<lambda>x [O!]x & x =\<^sub>E u]u\<close>
      by (rule betaC_2_a; "cqt:2[lambda]";
          safe intro!: "&I" "cqt:2[const_var]"[axiom_inst] ord_eq_Eequiv_1[THEN "\<rightarrow>E", OF Ordinary.\<psi>] Ordinary.\<psi>)
  next
  ...
  next
    ...
    proof(rule raa_cor_2)
      ...
      AOT_hence \<open>v =\<^sub>E u & \<not>(v =\<^sub>E u)\<close> by (metis intro_elim_3_d "reductio-aa:1" thm_neg_eq_E)
...
proof(rule "\<rightarrow>I")
  AOT_have nec0N: \<open>[\<lambda>x \<box>[\<nat>]x]0\<close>
    by (rule betaC_2_a; "cqt:2[lambda]"; simp add: zero_den RN zero_n)
  ...
  proof (rule 1[THEN "\<rightarrow>E"]; safe intro!: "&I" GEN "\<rightarrow>I" nec0N; frule "&E"(1); drule "&E"(2))
    ...
    AOT_hence \<open>\<box>([\<P>]xy & [\<nat>]x)\<close>
      by (metis "0" KBasic_3 Adjunction intro_elim_3_b "vdash-properties:10")
    ...
    AOT_show \<open>[\<lambda>x \<box>[\<nat>]x]y\<close>
      by (rule betaC_2_a; "cqt:2[lambda]"; simp add: "cqt:2[const_var]"[axiom_inst] 0)
  qed
...
proof(rule "\<rightarrow>I")
  AOT_have \<open>[[\<P>]\<^sup>+]0 n\<close>
    by (meson Number.\<psi> intro_elim_3_a nnumber_2)
...
proof(rule "\<rightarrow>I")
  AOT_have \<open>[[\<P>]\<^sup>+]0 n\<close>
    using Number.\<psi> intro_elim_3_a nnumber_2 by blast
...
proof (rule "\<rightarrow>I")
  ...
  ultimately AOT_show \<open>[\<nat>]x\<close>
    by (metis con_dis_i_e_4_c "reductio-aa:1")
qed
...
proof (rule "\<rightarrow>I")
  ...
  AOT_hence \<open>[\<nat>]b\<close> by (metis "&E"(1) intro_elim_3_b nnumber_2)
...
proof (safe intro!: GEN[where 'a=\<open><\<kappa>>\<close>] Number.GEN "&I" "\<rightarrow>I"; frule "&E"(1); drule "&E"(2))
  ...
  AOT_assume 0: \<open>\<forall>n\<forall>m([\<P>]nm \<rightarrow> ([F]n \<rightarrow> [F]m))\<close>
  {
    ...
    AOT_hence \<open>[\<nat>]x\<close> and \<open>[\<nat>]y\<close>
      using "&E" intro_elim_3_b nnumber_2 by blast+
  ...
  AOT_have 0: \<open>[[\<P>]\<^sup>+]0n\<close> by (metis intro_elim_3_a nnumber_2 Number.\<psi>)
...
proof(rule AOT_model_axiomI)
  ...
  proof(rule raa_cor_2)
    ...
    AOT_hence \<open>u \<noteq>\<^sub>E u\<close> by (metis betaC_1_a)
    moreover AOT_have \<open>u =\<^sub>E u\<close> using Ordinary.\<psi>
      using ord_eq_Eequiv_1 "vdash-properties:10" by blast
    ultimately AOT_show \<open>p & \<not>p\<close> for p
      by (smt (verit) AOT_sem_equiv AOT_sem_not thm_neg_eq_E)
  qed
  ...
  then obtain zero where zero_def: \<open>\<alpha>\<kappa> zero = \<guillemotleft>0\<guillemotright>\<close>               
    using AOT_sem_exe_denoting[OF oa_exist_2] AOT_sem_abstract
  ...
  moreover {
      ...
      by force
    {
      ...
      then obtain u where u_def: \<open>AOT_term_of_var x = \<omega>\<kappa> u\<close>
        by (metis AOT_concrete_sem AOT_model_concrete_\<kappa>.simps(2) AOT_model_denotes_\<kappa>_def AOT_sem_concrete AOT_sem_denotes AOT_sem_dia \<kappa>.exhaust_disc is_\<alpha>\<kappa>_def is_\<omega>\<kappa>_def russell_axiom_exe_1.\<psi>_denotes_asm)
  ...
  next
    ...
    thus \<open>[v \<Turnstile> \<exists>!x \<phi>{x}]\<close>
      using uniqueness_1[THEN "\<equiv>\<^sub>d\<^sub>fI"] by blast
  qed
    ...
    proof (rule bij_betw_byWitness[where f'=b2])
      {
        ...
        hence \<open>\<exists>!x . [w\<^sub>0 \<Turnstile> O!x] \<and> [w\<^sub>0 \<Turnstile> [\<Pi>']x] \<and> [w\<^sub>0 \<Turnstile> [R]\<guillemotleft>\<omega>\<kappa> a\<guillemotright>x]\<close> (is \<open>\<exists>!v . ?v v\<close>)
          ...
          by (meson AOT_var.AOT_term_of_var_inject russell_axiom_exe_1.\<psi>_denotes_asm)
        ...
        have ex1v: \<open>\<exists>!v . [w\<^sub>0 \<Turnstile> [\<Pi>']\<guillemotleft>\<omega>\<kappa> v\<guillemotright>] \<and> [w\<^sub>0 \<Turnstile> [R]\<guillemotleft>\<omega>\<kappa> a\<guillemotright>\<guillemotleft>\<omega>\<kappa> v\<guillemotright>]\<close>
          ...
          by (metis AOT_model.AOT_term_of_var_cases AOT_model_\<omega>\<kappa>_ordinary AOT_sem_denotes \<kappa>.inject(1) russell_axiom_exe_1.\<psi>_denotes_asm)
        ...
        ultimately have ex1u: \<open>\<exists>!u . [w\<^sub>0 \<Turnstile> [\<Pi>]\<guillemotleft>\<omega>\<kappa> u\<guillemotright>] \<and> [w\<^sub>0 \<Turnstile> [R]\<guillemotleft>\<omega>\<kappa> u\<guillemotright>\<guillemotleft>\<omega>\<kappa> v\<guillemotright>]\<close>
          ...
          by (meson AOT_model_\<omega>\<kappa>_ordinary \<kappa>.inject(1) russell_axiom_exe_1.\<psi>_denotes_asm)
  ...
  AOT_actually {
    ...
    proof(rule induction[THEN "\<forall>E"(1), OF model_nat_den, THEN "\<rightarrow>E", OF "&I", THEN "\<forall>E"(2), THEN "\<rightarrow>E"];
      ...
      AOT_obtain G where G_def: \<open>G = [F]\<^sup>-\<^sup>z\<close>
        by (metis "instantiation" AOT_sem_eq F_minus_u_den existential_1)
      ...
      moreover AOT_have \<open>[\<lambda>z \<^bold>\<A>[G]z] \<approx>\<^sub>E G\<close>
        ...
        apply (meson AOT_sem_act betaC_1_a)
      ...
      proof(rule "\<rightarrow>I")
        AOT_assume Fv: \<open>[F]z'\<close>
        {
          ...
          AOT_have \<open>[\<lambda>z' [F]z' & z' \<noteq>\<^sub>E z]z' \<or> z = z'\<close>
            apply (rule "\<or>I"(1))
            apply (rule betaC_2_a; "cqt:2[lambda]"; safe intro!: "cqt:2[const_var]"[axiom_inst] "&I" Fv)
            by (metis "0" AOT_sem_eq AOT_sem_equiv AOT_sem_not eq_E_simple_2 thm_neg_eq_E "vdash-properties:10")
        }
        moreover {
          AOT_assume \<open>z =\<^sub>E z'\<close>
          AOT_hence \<open>z = z'\<close> by (metis eq_E_simple_2 "vdash-properties:6")
          AOT_hence \<open>[\<lambda>z' [F]z' & z' \<noteq>\<^sub>E z]z' \<or> z = z'\<close>
            by (rule "\<or>I"(2))
        }
        ultimately AOT_show \<open>[\<lambda>z' [F]z' & z' \<noteq>\<^sub>E z]z' \<or> z = z'\<close> using con_dis_i_e_3_b raa_cor_1 by blast
      qed
...
(*********************************)
    ...
    next
      ...
      proof(rule raa_cor_2)
        ...
        AOT_hence \<open>z = \<guillemotleft>\<omega>\<kappa> x\<guillemotright>\<close>
          by (metis AOT_model.AOT_term_of_var_cases AOT_model_denotes_\<kappa>_def AOT_sem_not \<kappa>.disc(7) eq_E_simple_2 "modus-tollens:1")
      ...
      AOT_thus \<open>z \<noteq>\<^sub>E \<guillemotleft>\<omega>\<kappa> x\<guillemotright>\<close>
        by (metis AOT_model.AOT_term_of_var_cases AOT_model_denotes_\<kappa>_def AOT_sem_equiv \<kappa>.disc(7) thm_neg_eq_E) 
    next
  ...
  AOT_modally_strict {
    fix x G
    AOT_assume \<open>[\<nat>]x\<close>
    AOT_hence ActNm: \<open>\<^bold>\<A>[\<nat>]x\<close> by (metis mod_col_num_1 nec_imp_act "vdash-properties:10")
    AOT_assume \<open>x = #G\<close>
    AOT_hence \<open>\<^bold>\<A>x = #G\<close> by (metis AOT_sem_eq RA_2 id_eq_1)
    ...
    AOT_hence \<open>\<exists>y \<^bold>\<A>(O!y & \<forall>u ([G]u \<rightarrow> u \<noteq>\<^sub>E y))\<close>
      by (smt (z3) "instantiation" AOT_sem_act existential_2_a)
    ...
    AOT_hence \<open>\<^bold>\<A>O!y\<close> and 1: \<open>\<^bold>\<A>\<forall>u ([G]u \<rightarrow> u \<noteq>\<^sub>E y)\<close>
      using Act_Basic_2 "&E" intro_elim_3_a by blast+
    AOT_hence Oy: \<open>O!y\<close> by (metis intro_elim_3_b oa_facts_7)
    AOT_have 2: \<open>\<forall>u\<^bold>\<A>([G]u \<rightarrow> u \<noteq>\<^sub>E y)\<close> using 1 Ordinary.res_var_bound_reas_5 "vdash-properties:10" by fastforce
    {
      ...
      AOT_hence \<open>\<^bold>\<A>[G]b \<rightarrow> \<^bold>\<A>b \<noteq>\<^sub>E y\<close> by (metis act_cond "vdash-properties:6")
      ...
      AOT_hence \<open>b \<noteq>\<^sub>E y\<close>  by (metis id_act2_2 intro_elim_3_b)
    }
  ...
  AOT_modally_strict {
    ...
    AOT_hence \<open>\<exists>F\<exists>u ([F]u & Numbers(m,F) & Numbers(n,[F]\<^sup>-\<^sup>u))\<close>
      using intro_elim_3_a pred_thm_2 by blast
    ...
    proof(safe intro!: GEN "\<rightarrow>I")
      ...
      AOT_hence \<open>m = #G\<close> by (rule betaC_1_a)
      ...
      AOT_have \<open>[\<lambda>z \<diamond>E!z]y\<close>
        apply (rule AOT_ordinary[THEN "=\<^sub>d\<^sub>fE"(2)])
         apply "cqt:2[lambda]"
        by (fact Oy)
      AOT_hence \<open>\<diamond>E!y\<close> by (rule betaC_1_a)
      moreover {
        ...
        proof -
          ...
          AOT_show \<open>\<box>(\<^bold>\<A>[G]u \<rightarrow> u \<noteq>\<^sub>E y)\<close>
            ...
            using 0
            by (metis "deduction-theorem" id_nec_4_1 intro_elim_3_a "vdash-properties:10")
        qed
      ...
      ultimately AOT_have \<open>\<diamond>(\<forall>u(\<^bold>\<A>[G]u \<rightarrow> u \<noteq>\<^sub>E y) & E!y)\<close>
        using KBasic_16 "&I" "vdash-properties:6" by blast
      AOT_hence \<open>\<diamond>(E!y & \<forall>u(\<^bold>\<A>[G]u \<rightarrow> u \<noteq>\<^sub>E y))\<close>
        using "RE\<diamond>" intro_elim_3_a oth_class_taut_2_a by blast
  ...
  AOT_modally_strict {
    ...
    AOT_obtain F where F_def: \<open>F = [\<lambda>x \<forall>G ([\<nat>]x & [\<lambda>x x = #G]x \<rightarrow> \<diamond>\<exists>y([E!]y & \<forall>u (\<^bold>\<A>[G]u \<rightarrow> u \<noteq>\<^sub>E y)))]\<close>
      by (metis (no_types, lifting) "0" "instantiation" "rule=I_1" existential_1 id_sym) 
    ...
    proof(safe intro!: Number.GEN "\<rightarrow>I")
      ...
      AOT_have \<open>[\<lambda>x \<forall>G ([\<nat>]x & [\<lambda>x x = #G]x \<rightarrow> \<diamond>\<exists>y([E!]y & \<forall>u (\<^bold>\<A>[G]u \<rightarrow> u \<noteq>\<^sub>E y)))]m\<close>
        by (rule betaC_2_a; "cqt:2[lambda]"; simp add: 0 "cqt:2[const_var]"[axiom_inst])
    ...
    qed
    {
      ...
      proof (rule "rule=E"[rotated, OF F_def[symmetric]]; rule betaC_2_a; "cqt:2[lambda]"; safe intro!: zero_den "&I" zero_n GEN "\<rightarrow>I")
        fix G
        ...
        ultimately AOT_have \<open>\<diamond>(\<forall>u (\<^bold>\<A>[G]u \<rightarrow> u \<noteq>\<^sub>E v) & E!v)\<close>
          using KBasic_16 "&I" "vdash-properties:10" by fast
        AOT_hence \<open>\<diamond>(E!v & \<forall>u (\<^bold>\<A>[G]u \<rightarrow> u \<noteq>\<^sub>E v))\<close>
          using "RE\<diamond>" intro_elim_3_d oth_class_taut_2_a raa_cor_3 by blast
    ...
    proof(rule "\<rightarrow>I")
      ...
      moreover AOT_have \<open>[\<lambda>x x = #G]x\<close>
        by (rule betaC_2_a; simp add: being_number_of_den; simp add: "cqt:2[const_var]"[axiom_inst] x_prop[THEN "&E"(2)])
...
proof(safe intro!: "\<rightarrow>I" Ordinary.GEN)
  ...
  AOT_hence \<open>\<box>\<^bold>\<A>[G]u\<close>
    by (metis Act_Basic_6 intro_elim_3_a)
  ...
  AOT_thus \<open>u \<noteq>\<^sub>E v\<close> by (metis id_nec_4_2 intro_elim_3_a) 
qed

AOT_theorem th_succ: \<open>\<forall>n\<exists>!m [\<P>]nm\<close>
proof(safe intro!: Number.GEN "\<rightarrow>I" uniqueness_1[THEN "\<equiv>\<^sub>d\<^sub>fI"])
  fix n
  ...
  AOT_hence 1: \<open>\<diamond>E!y\<close> and 2: \<open>\<diamond>\<forall>u(\<^bold>\<A>[G]u \<rightarrow> u \<noteq>\<^sub>E y)\<close>
    using KBasic2_3 "&E" "\<rightarrow>E" by blast+
  ...
  proof(safe intro!: pred_thm_2[THEN "\<equiv>E"(2)] "\<exists>I"(1)[where \<tau>=\<open>\<guillemotleft>[\<lambda>x \<^bold>\<A>[G]x \<or> x =\<^sub>E y]\<guillemotright>\<close>] 1 "\<exists>I"(2)[where \<beta>=y] "&I" Oy b_prop)
    AOT_show \<open>[\<lambda>x \<^bold>\<A>[G]x \<or> x =\<^sub>E y]y\<close>
      by (rule betaC_2_a; "cqt:2[lambda]";
          auto intro!: "cqt:2[const_var]"[axiom_inst] "\<or>I"(2) ord_eq_Eequiv_1[THEN "\<rightarrow>E", OF Oy])
  next
    ...
    proof(rule apE_eqE_1[unvarify F G, THEN "\<rightarrow>E"]; ("cqt:2[lambda]" | rule F_minus_u_den[unvarify F]; "cqt:2[lambda]")?)
      ...
      proof (safe intro!: eqE[THEN "\<equiv>\<^sub>d\<^sub>fI"] "&I" F_minus_u_den[unvarify F] Ordinary.GEN "\<rightarrow>I"; "cqt:2[lambda]"?)
        ...
        AOT_have \<open>[[\<lambda>x \<^bold>\<A>[G]x \<or> [(=\<^sub>E)]xy]\<^sup>-\<^sup>y]u \<equiv> ([\<lambda>x \<^bold>\<A>[G]x \<or> x =\<^sub>E y]u) & u \<noteq>\<^sub>E y\<close>
          ...
          by (rule beta_C_cor_2[THEN "\<rightarrow>E", THEN "\<forall>E"(2)]; "cqt:2[lambda]")
        also AOT_have \<open>\<dots> \<equiv>  (\<^bold>\<A>[G]u \<or> u =\<^sub>E y) & u \<noteq>\<^sub>E y\<close>
          apply (AOT_subst \<open>\<guillemotleft>[\<lambda>x \<^bold>\<A>[G]x \<or> [(=\<^sub>E)]xy]u\<guillemotright>\<close> \<open>\<guillemotleft>\<^bold>\<A>[G]u \<or> u =\<^sub>E y\<guillemotright>\<close>)
           apply (rule beta_C_cor_2[THEN "\<rightarrow>E", THEN "\<forall>E"(2)]; "cqt:2[lambda]")
          using oth_class_taut_3_a by blast
        also AOT_have \<open>\<dots> \<equiv> \<^bold>\<A>[G]u\<close>
        proof(safe intro!: "\<equiv>I" "\<rightarrow>I")
          AOT_assume \<open>(\<^bold>\<A>[G]u \<or> u =\<^sub>E y) & u \<noteq>\<^sub>E y\<close>
          AOT_thus \<open>\<^bold>\<A>[G]u\<close> by (metis "&E"(1) "&E"(2) con_dis_i_e_4_c intro_elim_3_a thm_neg_eq_E)
        next
          AOT_assume \<open>\<^bold>\<A>[G]u\<close>
        ...
        also AOT_have \<open>\<dots> \<equiv> [\<lambda>x \<^bold>\<A>[G]x]u\<close>
          by (rule beta_C_cor_2[THEN "\<rightarrow>E", THEN "\<forall>E"(2), symmetric]; "cqt:2[lambda]")
...
AOT_theorem suc_den': \<open>\<^bold>\<iota>m([\<P>]nm)\<down>\<close>
  using A_Exists_2 RA_2 intro_elim_3_b th_succ[THEN "Number.\<forall>E"] by blast
(* TODO: not in PLM *)
...
proof -
  ...
  moreover {
    ...
    AOT_have Nz: \<open>[\<nat>]z\<close> using \<theta> intro_elim_3_b nnumber_2 by blast
    moreover AOT_have \<open>m = z\<^bold>'\<close>
    proof (rule def_suc[THEN "=\<^sub>d\<^sub>fI"(1)];
           safe intro!: suc_den'[unconstrain n, THEN "\<rightarrow>E", OF Nz] nec_hintikka_scheme[THEN "\<equiv>E"(2)] "&I"
                        GEN "\<rightarrow>I" Act_Basic_2[THEN "\<equiv>E"(2)])
      AOT_show \<open>\<^bold>\<A>[\<nat>]m\<close> using Number.\<psi>
        by (meson mod_col_num_1 nec_imp_act "vdash-properties:10")
    next
      AOT_show \<open>\<^bold>\<A>[\<P>]zm\<close> using \<xi>
        by (meson nec_imp_act pred_1_1_1 "vdash-properties:6")
    next
      fix y
      ...
      AOT_hence 0: \<open>[\<P>]zy\<close>
        by (metis RN intro_elim_3_a pred_1_1_1 sc_eq_fur_2 "vdash-properties:10")
...
proof -
  AOT_obtain x where m_is_n: \<open>x = n\<^bold>'\<close>
    using free_thms_1[THEN "\<equiv>E"(1), OF suc_den]
  ...
  AOT_have \<open>\<^bold>\<A>([\<nat>]n\<^bold>' & [\<P>]n n\<^bold>')\<close>
    ...
    apply (rule actual_desc_4[THEN "\<rightarrow>E"])
    by (simp add:  suc_den')
  AOT_hence \<open>\<^bold>\<A>[\<nat>]n\<^bold>'\<close> and \<open>\<^bold>\<A>[\<P>]n n\<^bold>'\<close>
    using Act_Basic_2 intro_elim_3_a "&E" by blast+
...
proof -
  {
    ...
    AOT_hence 0: \<open>\<forall>F \<not>([F]x & \<not>[F]y)\<close> by (metis cqt_further_4 "vdash-properties:10")
    ...
    proof (rule GEN; rule "\<equiv>I"; rule "\<rightarrow>I")
      ...
      ultimately AOT_show \<open>[F]y\<close> by (metis "&I" raa_cor_1) 
    next
      fix F
      AOT_assume \<open>[F]y\<close>
      AOT_hence \<open>\<not>[\<lambda>x \<not>[F]x]y\<close> by (metis "\<not>\<not>I" betaC_1_b)
      moreover AOT_have \<open>\<not>([\<lambda>x \<not>[F]x]x & \<not>[\<lambda>x \<not>[F]x]y)\<close>
        apply (rule 0[THEN "\<forall>E"(1)]) by "cqt:2[lambda]"
      ultimately AOT_have 1: \<open>\<not>[\<lambda>x \<not>[F]x]x\<close> by (metis "&I" raa_cor_3)
      {
        AOT_assume 0: \<open>\<not>[F]x\<close>
        AOT_have \<open>[\<lambda>x \<not>[F]x]x\<close>
          apply (rule betaC_2_a; "cqt:2[lambda]")
          by (simp add: 0 "cqt:2[const_var]"[axiom_inst])+
        AOT_hence \<open>p & \<not>p\<close> for p using 1 by (metis raa_cor_3)
      }
      AOT_thus \<open>[F]x\<close> by (metis raa_cor_1)
    qed
  ...
  } note indistI = this
  {
...

    {
      ...
      proof (rule raa_cor_2)
        ...
        moreover AOT_have \<open>\<forall>u\<box>([G]u \<equiv> [G]u)\<close>
          by (simp add: RN oth_class_taut_3_a universal_cor "vdash-properties:9")
        ultimately AOT_have \<open>y[G]\<close> using "\<forall>E"(2) "\<rightarrow>E" by blast
        AOT_thus \<open>p & \<not>p\<close> for p using G_prop "&E" by (metis raa_cor_3)
      qed
    ...
    ultimately AOT_have \<open>\<exists>F([F]x & \<not>[F]y)\<close>  by (metis raa_cor_1)
  }
  moreover {
    AOT_assume G_prop: \<open>\<not>x[G] & y[G]\<close>
    AOT_hence Ay: \<open>A!y\<close>
      by (meson "&E"(2) encoders_are_abstract existential_2_a "vdash-properties:10")
    AOT_hence notOy: \<open>\<not>O!y\<close>
      using intro_elim_3_a oa_contingent_3 by blast
    {
      ...
      proof (rule raa_cor_2)
        ...
        AOT_thus \<open>p & \<not>p\<close> for p using F_prop[THEN "&E"(2)] by (metis raa_cor_3)
      qed
      ...
      proof (rule raa_cor_1)
        ...
        AOT_hence 0: \<open>\<forall>F \<not>(\<forall>u \<box>([F]u \<equiv> [G]u) & y[F])\<close> using cqt_further_4[THEN "\<rightarrow>E"] by blast
        {
          fix F
          {
            AOT_assume \<open>\<forall>u \<box>([F]u \<equiv> [G]u)\<close>
            AOT_hence \<open>\<not>y[F]\<close> using 0[THEN "\<forall>E"(2)] using "&I" raa_cor_1 by meson
          }
...
OF Ax, OF Ay, OF indist, THEN "\<equiv>E"(2), OF y_prop] x_prop "&I" by blast
  ...
  ultimately AOT_show \<open>\<exists>F([F]x & \<not>[F]y)\<close>
    using G_prop by (metis "&I" "deduction-theorem" intro_elim_2 raa_cor_1)
qed
...

    {
        ...
        then AOT_obtain H where H_prop: \<open>\<forall>u([H]u \<equiv> [G]u) & \<not>(x[H] \<equiv> y[H])\<close> using "\<exists>E"[rotated] by blast
        {
          fix F
          {
            ...
            moreover AOT_hence 2: \<open>[F]u \<equiv> [G]u\<close> for u using H_prop[THEN "&E"(1), THEN "Ordinary.\<forall>E"]
              by (metis intro_elim_3_e)
            ultimately AOT_have 3: \<open>[H]u \<equiv> [G]u\<close> for u by (metis intro_elim_3_f)
            ...
            ultimately AOT_have \<open>x[F] \<equiv> x[H]\<close> by (metis "deduction-theorem" intro_elim_2 intro_elim_3_a intro_elim_3_b)
          }
        ...
        using A by presburger
      {
        ...
        AOT_hence \<open>\<not>\<forall>F (\<forall>u([F]u \<equiv> [G]u) \<rightarrow> (x[F] \<equiv> x[G])) \<or> (x[G] \<equiv> y[G])\<close>
          using "&I" con_dis_i_e_3_a con_dis_i_e_3_b "reductio-aa:1" by meson
        AOT_hence \<open>\<forall>F (\<forall>u([F]u \<equiv> [G]u) \<rightarrow> (x[F] \<equiv> x[G])) \<rightarrow> (x[G] \<equiv> y[G])\<close>
          using "\<not>\<not>I" con_dis_i_e_4_b "deduction-theorem" by meson
      }
    }
  }
end
...
proof -
  AOT_modally_strict {
    ...
    proof(rule raa_cor_1)
      ...
      AOT_hence \<open>\<exists>G \<not>(\<forall>u ([G]u \<equiv> [F]u) \<rightarrow> y[G])\<close> using cqt_further_2 "vdash-properties:10" by blast
      then AOT_obtain G where G_prop: \<open>\<not>(\<forall>u ([G]u \<equiv> [F]u) \<rightarrow> y[G])\<close> using "\<exists>E"[rotated] by blast
      AOT_hence 1: \<open>\<forall>u ([G]u \<equiv> [F]u) & \<not>y[G]\<close> by (metis intro_elim_3_a oth_class_taut_1_b)
      ...
      AOT_hence B: \<open>\<not>(x[G] \<equiv> y[G])\<close>
        using "&E"(2) intro_elim_3_a "reductio-aa:1" xG by blast
      {
        fix H
        {
...
proof -
  AOT_modally_strict {
    ...
    proof(rule raa_cor_1)
      ...
      AOT_hence \<open>\<exists>G \<not>(\<forall>u ([G]u \<equiv> [F]u) \<rightarrow> \<not>y[G])\<close> using cqt_further_2 "vdash-properties:10" by blast
      then AOT_obtain G where G_prop: \<open>\<not>(\<forall>u ([G]u \<equiv> [F]u) \<rightarrow> \<not>y[G])\<close> using "\<exists>E"[rotated] by blast
      AOT_hence 1: \<open>\<forall>u ([G]u \<equiv> [F]u) & \<not>\<not>y[G]\<close> by (metis intro_elim_3_a oth_class_taut_1_b)
      AOT_hence yG: \<open>y[G]\<close>
        using G_prop "deduction-theorem" raa_cor_3 by blast
      ...
      AOT_hence B: \<open>\<not>(x[G] \<equiv> y[G])\<close> by (metis "12" intro_elim_3_c raa_cor_3 yG)
      {
        fix H
        {
          AOT_assume 3: \<open>\<forall>u ([H]u \<equiv> [G]u)\<close>
          ...
          AOT_hence \<open>x[H] \<equiv> x[G]\<close> using 12 "\<equiv>I" "\<rightarrow>I" by (metis raa_cor_3)
        }
        AOT_hence \<open>\<forall>u ([H]u \<equiv> [G]u) \<rightarrow> (x[H] \<equiv> x[G])\<close> by (rule "\<rightarrow>I")
      }
      AOT_hence A: \<open>\<forall>H(\<forall>u ([H]u \<equiv> [G]u) \<rightarrow> (x[H] \<equiv> x[G]))\<close> by (rule GEN)
...
proof -
  AOT_modally_strict {
    ...
    AOT_assume indist: \<open>\<forall>F ([F]x \<equiv> [F]y)\<close>
    {
      ...
      proof(safe intro!: "\<rightarrow>I")
        ...
        proof (rule betaC_2_a; simp add: denotes_all'; safe intro!: "cqt:2[const_var]"[axiom_inst] GEN "\<rightarrow>I")
          fix G
          ...
          AOT_thus \<open>x[G]\<close> using xF by (metis intro_elim_3_b)
        qed
        ...
        moreover AOT_have \<open>\<forall>u ([F]u \<equiv> [F]u)\<close>
          by (simp add: oth_class_taut_3_a universal_cor "vdash-properties:9")
    ...
    moreover {
      ...
      proof(safe intro!: "\<rightarrow>I")
        ...
        proof (rule betaC_2_a; simp add: denotes_ex'; safe intro!: "cqt:2[const_var]"[axiom_inst] GEN "\<rightarrow>I")
          fix G
          AOT_assume \<open>\<forall>u ([G]u \<equiv> [F]u)\<close>
          AOT_hence \<open>x[G] \<equiv> x[F]\<close> using 0[THEN "\<forall>E"(2), THEN "\<rightarrow>E"] by blast
          AOT_thus \<open>\<not>x[G]\<close> using notxF by (metis intro_elim_3_d)
        qed
        ...
        proof (safe intro!: GEN "\<rightarrow>I")
          ...
          AOT_thus \<open>y[G] \<equiv> y[F]\<close> using notyF "\<equiv>I" "\<rightarrow>I" by (metis raa_cor_3)
        qed
      qed
    }
  ...
  AOT_modally_strict {
    ...
    AOT_hence indist': \<open>\<forall>F ([F]y \<equiv> [F]x)\<close>
      by (metis cqt_basic_11 intro_elim_3_a)
    ...
    proof(safe intro!: "\<rightarrow>I" GEN)
      ...
      AOT_assume 0: \<open>\<forall>F (x[F] \<equiv> \<phi>{F})\<close>
      {
        fix G
        {
          ...
          ultimately AOT_have \<open>x[G] \<equiv> x[F]\<close> by (metis intro_elim_3_f oth_class_taut_3_a)
        }
      ...
      AOT_have \<open>[\<lambda>x \<forall>G (\<forall>u([G]u \<equiv> [F]u) \<rightarrow> (x[G] \<equiv> x[F]))]x\<close>
        by (rule betaC_2_a; simp add: denotes_equiv; simp add: "cqt:2[const_var]"[axiom_inst] 1)
      ...
      AOT_hence 2: \<open>\<forall>G (\<forall>u([G]u \<equiv> [F]u) \<rightarrow> (y[G] \<equiv> y[F]))\<close> by (rule betaC_1_a)
      ...
      proof (safe intro!: "\<equiv>I" "\<rightarrow>I")
        ...
        AOT_have \<open>[\<lambda>y \<forall>G (\<forall>u([G]u \<equiv> [F]u) \<rightarrow> y[G])]y\<close>
          by (rule betaC_2_a; simp add: denotes_all'; simp add: "cqt:2[const_var]"[axiom_inst] 3)
        ...
        AOT_hence \<open>\<forall>G (\<forall>u([G]u \<equiv> [F]u) \<rightarrow> x[G])\<close> by (rule betaC_1_a)
        moreover AOT_have \<open>\<forall>u([F]u \<equiv> [F]u)\<close>
          by (simp add: oth_class_taut_3_a universal_cor "vdash-properties:9")
      ...
      next
        ...
        AOT_hence \<open>[\<lambda>x \<forall>G(\<forall>u([G]u \<equiv> [F]u) \<rightarrow> x[G])]y\<close>
          using indist[THEN "\<forall>E"(1), OF denotes_all', THEN "\<equiv>E"(1)] by blast
        AOT_hence \<open>\<forall>G(\<forall>u([G]u \<equiv> [F]u) \<rightarrow> y[G])\<close> by (rule betaC_1_a)
        moreover AOT_have \<open>\<forall>u([F]u \<equiv> [F]u)\<close>
          by (simp add: oth_class_taut_3_a universal_cor "vdash-properties:9")
    ...
    proof (safe intro!: GEN RN "\<rightarrow>I")
      AOT_modally_strict {
        ...
        proof(safe intro!: "\<equiv>I" "\<rightarrow>I")
          ...
          ultimately AOT_have \<open>[G]u \<equiv> [H]u\<close> for u by (metis "deduction-theorem" intro_elim_2 intro_elim_3_a intro_elim_3_b)
        ...
        next
          ...
          moreover AOT_have \<open>[G]u \<equiv> [F]u\<close> for u using 0 "Ordinary.\<forall>E" by fast
          ultimately AOT_have \<open>[F]u \<equiv> [H]u\<close> for u by (metis "deduction-theorem" intro_elim_2 intro_elim_3_a intro_elim_3_b)
